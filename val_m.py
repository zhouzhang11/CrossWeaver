...
model = YOLO_m('/home/sysspace/yanght/test/new/DroneVehicle/yolov8s_new_model10/weights/best.pt')
...
data = '/home/sysspace/yanght/test/new/ultralytics/cfg/datasets/drone_vehicle_m.yaml'
model.val(data=data,
          project='PLOT',
